...
public class InventoryService {
    ...
    public void save(Product product, User user) throws SQLException, ValidationException {
        ...
        if (product.getId() == 0) {
            ...
            movementDao.record(id, user == null ? null : user.getId(), "CREATE", product.getQuantity(), "Product registered.");
        } else {
            ...
            movementDao.record(product.getId(), user == null ? null : user.getId(), "UPDATE", change, "Product updated.");
        }
    }
    ...
    public void delete(Product product, User user) throws SQLException {
        ...
        movementDao.record(product.getId(), user == null ? null : user.getId(), "DELETE", -product.getQuantity(), "Product deleted.");
